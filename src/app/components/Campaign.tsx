                            ...
                            <div className="relative h-24 md:h-40 rounded-t-md overflow-hidden">
                              ...
                              <div className="absolute top-1.5 md:top-2 left-1.5 md:left-2 flex gap-1">
                                {offer.platforms.slice(0, 2).map((p) => (
                                  <div key={p} className="w-4 h-4 md:w-6 md:h-6 bg-[#004DF6]/20 backdrop-blur-md rounded flex items-center justify-center text-[#004DF6] border border-[#004DF6]/50 shadow-lg">
                                    <PlatformIcon platform={p} />
                                  </div>
                                ))}
                              </div>
                              <div className="absolute top-1.5 md:top-2 right-1.5 md:right-2">
                                <span className="inline-flex items-center px-1.5 md:px-2 py-0.5 rounded text-[10px] md:text-xs font-semibold bg-[#004DF6]/20 backdrop-blur-md text-[#004DF6] border border-[#004DF6]/50 shadow-lg">{offer.type}</span>
                              </div>
                            </div>
