...
export function MyPage() {
    ...
    const { getAppliedCampaigns } = useCampaigns();
                        ...
                        <nav className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                            {menuItems.map((item, idx) => (
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-4 py-3 text-sm font-medium transition-all ${idx !== menuItems.length - 1 ? "border-b border-gray-50" : ""
                            ...
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold transition-all ${saved
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {CONTENT_SPECIALTIES.map((option) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-xl text-sm font-medium border transition-all ${form.contentSpecialty === option
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {STRONGEST_POINTS.map((option) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-xl text-sm font-medium border transition-all ${form.strongestPoint === option
                                                            ? "bg-[#004DF6] text-white border-[#004DF6] shadow-[0_4px_12px_rgba(0,77,246,0.25)]"
                                                            : "bg-gray-50 text-gray-600 border-gray-200 hover:border-[#004DF6]/40 hover:bg-[#f0f4ff]"
                                                        }`}
                                                >
                                            ...
                                            {SHOOT_FORMATS.map((format) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`px-4 py-2 rounded-xl text-sm font-medium border transition-all flex items-center gap-2 ${selected
                                                                ? "bg-[#004DF6] text-white border-[#004DF6] shadow-[0_4px_12px_rgba(0,77,246,0.25)]"
                                                                : "bg-gray-50 text-gray-600 border-gray-200 hover:border-[#004DF6]/40 hover:bg-[#f0f4ff]"
                                                            }`}
                                                    >
