...
export interface CampaignOffer {
  ...
  requirements: string[];
  deliverables: string[];
  featured: boolean; // Featured & Urgent 섹션에 표시 여부
}
...
const defaultCampaigns: CampaignOffer[] = [
  {
    ...
    title: "Luxury Skincare Product Review",
    ...
    requirements: [
      ...
      "Beauty/lifestyle content focus",
      "High engagement rate (3%+)",
      "English fluency required",
    ],
    deliverables: [
      "2 Instagram posts with product photos",
      "3 Instagram stories",
      "1 TikTok video (30-60 seconds)",
      "Honest review and tag @glowskinbeauty",
    ],
    featured: true,
  },
  {
    ...
    title: "Restaurant Experience & Food Review",
    currentApplicants: 8,
    maxApplicants: 10,
    ...
    requirements: [
      "Food/lifestyle influencer",
      "Located in or able to travel to New York City",
      "Minimum 15K followers",
      "Professional food photography skills",
    ],
    deliverables: [
      "1 YouTube video (5-10 minutes) restaurant tour and review",
      "5-7 Instagram posts featuring different dishes",
      "Instagram Reels of the dining experience",
    ],
    featured: true,
  },
  {
    ...
    title: "Spring Fashion Collection Showcase",
    ...
    requirements: [
      ...
      "Minimum 25K followers across platforms",
      "Strong visual aesthetic",
      "Previous brand collaboration experience",
    ],
    deliverables: [
      "3 Instagram feed posts with outfit styling",
      "5 TikTok videos showing different looks",
      "1 YouTube styling video or try-on haul",
      "Stories throughout the campaign period",
    ],
    featured: false,
  },
  {
    ...
    daysLeft: 7,
    company: "FitLife Gym",
    title: "Fitness Challenge & Equipment Demo",
    ...
    requirements: [
      "Fitness/wellness content creator",
      "Based in Los Angeles area",
      "Minimum 20K followers",
      "Consistent posting schedule",
    ],
    deliverables: [
      "Weekly progress TikTok videos (4 total)",
      "2 YouTube workout routine videos",
      "Daily Instagram stories during challenge",
  ...
  },
  {
    ...
    title: "Coffee Culture & Cafe Experience",
    ...
    requirements: [
      "Lifestyle/food photographer",
      "Located in Seattle area",
      "Strong Instagram aesthetic",
      "Minimum 8K followers",
    ],
    deliverables: [
      "4 high-quality Instagram posts",
      "10+ Instagram stories",
      "Coffee preparation Reels",
      "Tag location and use branded hashtags",
    ],
    featured: true,
  },
  {
    ...
    requirements: [
      "Tech reviewer/enthusiast",
      "Minimum 30K YouTube subscribers",
      "Professional video production quality",
      "Previous tech review experience",
    ],
    deliverables: [
      "1 detailed YouTube review video (10-15 min)",
      "Unboxing TikTok video",
      "3-5 feature highlight TikToks",
...
export function CampaignProvider({ children }: { children: ReactNode }) {
  ...
  const toggleFeatured = (id: number) => {
    setCampaigns(campaigns.map((c) => (c.id === id ? { ...c, featured: !c.featured } : c)));
  };

  return (
    <CampaignContext.Provider
      value={{ campaigns, setCampaigns, addCampaign, updateCampaign, deleteCampaign, toggleFeatured }}
    >
      {children}
    </CampaignContext.Provider>
  );
